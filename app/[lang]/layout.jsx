...
export const metadata = {
	title: {
		default: "Altair Hotel, Samarkand - Official Site",
		template: "%s - Altair Hotel",
	},
	category: "hotel",
	description:
		"Гостиница Altair предлагает уютные номера и первоклассный сервис в центре города. Забронируйте номер и насладитесь комфортным отдыхом!",
	openGraph: {
		title: "Altair Hotel",
		description:
			"Гостиница Altair предлагает уютные номера и первоклассный сервис в центре города. Забронируйте номер и насладитесь комфортным отдыхом!",
		...
		images: [
			{
				url: "https://www.altair-hotel.uz/images/services/transfer.webp",
				width: 800,
				height: 600,
				alt: "Altair Hotel",
			},
			...
			<body className={RobotoFont.className}>
				<Head>
					...
					<meta
						...
						content="Гостиница Altair предлагает уютные номера и первоклассный сервис в центре города. Забронируйте номер и насладитесь комфортным отдыхом!"
					/>
